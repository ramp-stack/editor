...
use crate::editor::highlight::load_json_theme;
use crate::editor::viewer::{file_lang, file_mode, FileMode, Lang};
...
impl Editor {
    ...
    pub fn with_id(
        ...
        let theme = Shared::new(load_json_theme(theme_bytes));
    ...
    pub fn open_file(&self, file_path: &str) {
        ...
        let lines: Vec<String> = if new_mode == FileMode::Image {
            vec![]
        } else {
